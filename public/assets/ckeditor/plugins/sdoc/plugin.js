CKEDITOR.plugins.add('sdoc', {
    ...
    init: function (editor) {
        editor.addCommand('sdoc', {
            exec: function (editor) {
                a = document.createElement('input');
                a.setAttribute('type', 'file');
                a.setAttribute('accept', '.doc,.docx');
                a.click()
                a.onchange = function () {
                    file = a.files[0];
                    ...
                    loaderHtmlStr = '<div style="position: relative; z-index: 100;width: 100%;height: 100%;text-align: center;background: white;opacity: 0.75;pointer-events:none">' + '<div style="width: 100%;height: 30px;margin-top: 100px;">Please wait while Doc is uploading...</div>' + '</div>'
...
//                                    imgElem = '<img src="' + url + '" class="image-editor" data-width="' + inputWidth + '" data-height="' + inputHeight + '" height="' + height + '" width="' + width + '">'
        ...
        editor.ui.addButton('SDoc', {
            label: 'Custom Doc Uploader',
            command: 'sdoc',
            toolbar: 'insert'
        });
    }
