...
<div class="container ss_reg_form">
    <div class="row">
     <div class="col-sm-6 col-sm-offset-3">
        ...
        if ($local_session->get('token_error')) {
            echo $local_session->get('token_error');
            $local_session->remove('token_error');
        }?>
 ...
 $('#btnSave').click(function(e){
    ...
    if(j==0 && k==0 && l==0 && m==0 && n==0 && o==0 && lll==0 && p == 0 && q == 0 ){ 
        ...
        $.ajax({
            ...
            async: false,
            dataType:'json',
            url: '<?php echo base_url();?>/save_school',
            data:data,
   ...
   $('#school_otp_check').click(function(){
    ...
    $.ajax({
            ...
            async: false,
            dataType:'html',
            url: '<?php echo base_url();?>/sure_school_data_save',
            data:data_up_modal,
            success: function(msg)
            {
                if(msg==1){
