     ...
     ?>
      ...
      <div class="col-md-10">
        <div class="alert alert-success alert-dismissible" role="alert" style="margin-top:10px;"> 
          ...
          <strong><?php echo $local_session->get('success_msg') ?> <span style="color: red;">  Note: If you don't see a confirmation e-mail than please check your bluk/spam folder.We sent a sms to your mobile for account details.  </span> 
        <?php 
        $local_session->remove('success_msg')
        ?>
        </strong>
        </div>
      </div>
      ...
      <div class="col-sm-4">
         <div class="ss_home_left_new">
            ...
            <div class="left_banner2 bottom10 ss_l_img">
              <a href="<?php echo base_url();?>/video"><img class="img-responsive "  src="<?php echo base_url();?>/assets/images/h_left_video.png"></a>
            </div>
        </div>
