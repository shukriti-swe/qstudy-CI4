...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="button_schedule text-right" >
            ...
            <a class="btn btn_next" href="<?php echo base_url();?>/add_product"><i class="fa fa-file"></i> Add New</a>
        </div>
        <?php 
        ...
        if (!empty( $this->session->get('success') )) { ?>
          <div class="row">
            ...
            <div class="alert alert-success col-md-9" style="margin-left: 56px;"><?php echo $this->session->get('success'); ?> </div>
          </div>
        <?php  } ?>
        <div class="sign_up_menu" id="product_div">
            <?php require_once(APPPATH.'Views/admin/product/product_div.php');?>
        </div>
    </div>
</div>
