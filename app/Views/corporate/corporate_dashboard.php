...
<?php } else{ ?>
<div class="">
    <p class="text-center" style="font-size: 25px;font-weight: 700;color: #0078ae;"><?=$user_info[0]['name'];?></p><br><br>
    <ul class="personal_ul">
        <li class="presonal"><a href="<?php echo base_url(); ?>/corporate_setting">Personal</a></li>
