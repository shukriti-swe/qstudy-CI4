...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '.com_hint_image', function() {
          ...
          $('#second_section').show();
          $('#first_section').hide();
          var wrrite_input = CKEDITOR.instances['writing_input'].document.getBody().getText();
          var all_words = wrrite_input.split(" ");
          ...
          for(var i=0; i<all_words.length;i++){
              ...
              if(jQuery.inArray(''+i+'', one_hint_no) >= 0){
                var addStyle = 'style="background-color:'+text_one_hint_color+'"';
                var addData ='data-id="1"';
              }else if(jQuery.inArray(''+i+'', two_hint_no) >= 0){
                var addStyle = 'style="background-color:'+text_two_hint_color+'"';
                var addData ='data-id="2"';
              }else{
                var addStyle = '';
                var addData ='';
              }

              html += '<span data-index="'+i+'" class="hint_words word_no'+no+'"'+addData+addStyle+'>'+all_words[i]+'</span>';
          }

          $('.hint_selection_content').html(html);
        ...
        if($('.hint_color_input_one').is(':checked')){
            ...
            var text_length = text_one.length;
            if(text_length>0){
            var final_text_one = '';
            ...
            $('.hint_words').each(function(){
            var chk_two = $(this).attr('data-id');
            
            if(chk_two != '' && chk_two==2){
                var get_text = $(this).text();
            ...
            var text_length = text_two.length;
            if(text_length>0){
                var final_text_two = '';
                for(var i=0;i<text_length;i++){
